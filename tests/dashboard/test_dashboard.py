...
class TestDashboard:
    def test_dashboard_displaying(self, dashboard_page_with_state: DashboardPage):
        dashboard_page_with_state.page.goto("https://nikita-filonov.github.io/qa-automation-engineer-ui-course/#/dashboard")
        
        # Добавляем проверку Sidebar компонента на странице Dashboard
        dashboard_page_with_state.sidebar.check_visible()
        
        # Добавляем проверку Navbar компонента на странице Dashboard
        dashboard_page_with_state.navbar.check_visible("fixture_user")
